...
import { AlertCircle, ArrowLeft, WifiOff, ServerCrash } from 'lucide-react';
...
const translations: Record<string, Record<string, string>> = {
  en: {
    ...
    somethingWentWrongDescription: "An unexpected error occurred while loading the institution details.",
  ...
  nl: {
    ...
    somethingWentWrongDescription: "Er is een onverwachte fout opgetreden bij het laden van de instellingsdetails.",
    genericErrorDetails: "Probeer het opnieuw. Als het probleem aanhoudt, neem contact op met ondersteuning.",
    tryAgain: "Probeer opnieuw",
    backToInstitutions: "Terug naar Instellingen",
        ...
        <div className="flex flex-col items-center justify-center py-16 text-center">
          ...
          <div className="flex gap-4">
            ...
            <Button asChild variant="outline">
              <Link href={`/${lang}/institutions`}>{t.backToInstitutions}</Link>
            </Button>
          </div>
